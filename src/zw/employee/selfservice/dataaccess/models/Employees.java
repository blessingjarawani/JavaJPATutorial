...
public class Employees extends  BaseEntity implements Serializable {
    ...
    public Set<zw.employee.selfservice.dataaccess.models.LeaveApplications> getLeaveApplication() {
        return LeaveApplication;
    }


    public void setLeaveApplication(Set<zw.employee.selfservice.dataaccess.models.LeaveApplications> leaveApplication) {
        LeaveApplication = leaveApplication;
    }

    public zw.employee.selfservice.dataaccess.models.Department getDepartment() {
        return Department;
    }

    public void setDepartment(zw.employee.selfservice.dataaccess.models.Department department) {
        Department = department;
    }


    public zw.employee.selfservice.dataaccess.models.Company getCompany() {
        return Company;
    }

    public void setCompany(zw.employee.selfservice.dataaccess.models.Company company) {
        Company = company;
    }
}
